...
inline void option_quit()
{
    std::cout << "Bye!\n";
}

inline void option_load_database(const fs::path& database_file_path, mdb::Database& database)
{
...
inline void option_display_database(const mdb::Database& database)
{
    std::cout << "Database contents:\n";
    database.display();
}

inline void option_find_artist(const mdb::Database& database, const std::string& text)
{
...
inline void option_find_album(const mdb::Database& database, const std::string& text)
{
...
inline void option_find_song(const mdb::Database& database, const std::string& text)
{
...
inline void option_find_anything_which_name_equals(const mdb::Database& database, const std::string& text)
{
