...
int main(int argc, char* argv[])
{
    ...
    auto database_and_result = mdb::load_database(database_file_path);
    const auto& database = database_and_result.first;
    const auto& result = database_and_result.second;
    switch (result)
    {
